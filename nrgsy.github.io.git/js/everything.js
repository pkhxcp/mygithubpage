...
function getTimeFromDec(hours){
    ...
    if(Math.floor((hours-Math.floor(hours))*60)%10==0){
        if(Math.floor((hours-Math.floor(hours))*60)==0){
            minstring="00";
        }
        minstring=""+Math.floor((hours-Math.floor(hours))*60)%10+"0";
    }
    else{
